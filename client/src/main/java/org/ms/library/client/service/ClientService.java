...
public class ClientService {
    ...
    private void copyDTOContentToEntity (ClientAddressUserDTO clientDTO,  Client entity, UserDTO userDTO, Address address) {
        ...
        entity.setAddress(clientDTO.getAddress() == null ? null : new Address(clientDTO.getAddress().getAddress(), clientDTO.getAddress().getCity(),
                clientDTO.getAddress().getState(), clientDTO.getAddress().getZip(), clientDTO.getAddress().getCountry(), entity));
